...
def plot_sleep_stages(predicted_stages):
    ...
    # Create a long horizontal plot
    plt.figure(figsize=(40, 6))  # Increase width for horizontal scrolling
    ...
    if st.button("Upload and Process"):
        if uploaded_file is not None:
            ...
            try:
                ...
                scrollable_container = st.container()  # Create a scrollable container
